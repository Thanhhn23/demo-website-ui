        ...
        fetch(`https://demo-website-api.vercel.app/api/v1/products/${id}`, {
            ...
            .then(data => {
                ...
                window.web_event.track("zoo", "process", {
                    items:  [{}],
                        dims: {"product":{parent_item_id : "1", ...data[0], comment:"Nhân viên bán hàng|Pnj nên xem lại thái độ của nhân viên bán hàng chiều ngày 05/09 nhé. Có 3 vấn đề cần nói ở đây:\n- Thứ nhất: làm dịch vụ mà thái độ hời hợt, ko niềm nở, ko nhiệt tình, nếu ko muốn nói là khá khó chịu. Khi khách nhờ tư vấn thì trả lời ngắn ngủn, cho có lệ, khách nhờ lấy cả 2 chiếc nhẫn 9999 loại 5 phân và 1 chỉ   để xem và so sánh thì  lại buông câu \"5 phân hay 1 chỉ đều giống nhau cả thôi\". Đâu ra cái cách trả treo như thế? \n- Thứ 2: khi tôi chuyển tiền bằng cách quét mã QR thì app Vietcombank đã thông báo trừ tiền nhưng lại hiện lỗi dữ liệu. Tôi kiểm tra lsgd thì có giao dịch trừ tiền thành công cho Pnj. Và tài khoản của tôi cũng đã bị trừ. Nhưng nhân viên báo là chưa nhận dc tiền, cái này tôi không trách được vì lỗi khách quan, nhưng cái cần nói ở đây là trách nhiệm của nhân viên, thay vì nhờ kế toán ktra ngay thì bạn lại bảo tôi tự đi liên hệ vs Vietcombank và khẳng định do NH máy tôi lỗi. Đến khi NH VCB xác nhận lỗi nằm ở cổng chuyển nhanh thì nhân viên mới nhờ đến kế toán, kế toán báo ko nhận dc giao dịch nào lỗi và cũng chưa nhận được tiền thì bạn lại tiếp tục bảo do tôi và khẳng định ko thể giao hàng cho tôi, sau khi tôi phân tích thì bạn mới bảo để ngày mai liên hệ lại sau. Cách xử lý vấn đề của bạn là quá tệ và quá vô trách nhiệm, tôi đứng trước mặt bạn chuyển tiền, show thông báo trừ tiền mà bạn cứ đẩy do NH tôi và kêu tôi về làm việc lại phía NH? V phía bạn thì sao? \n- Thứ 3: trong giờ làm ngồi chăm chú bấm điện thoại chứ cũng ko thèm nhìn khách, phải đợi khách gọi mới nhìn tới. Nên nhìn nhận lại cái gọi là \"dich vu tot\"", comment_array_string: ["abc","123 \n def"]}},
                        extra: {
                            title: "sac du phong",                       
                            keywords: "wifi"
                        }
